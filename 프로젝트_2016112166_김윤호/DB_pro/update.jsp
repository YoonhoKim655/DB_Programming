...
<%
    ...
    mySQL = "select s_name, s_addr, s_pwd, s_phone, s_overdue from staff where s_id='" + session_id + "'" ;
	...
	if (myResultSet.next()) {
		...
		String s_overdue = myResultSet.getString("s_overdue");		
%>
...
<form method="post" action="update_verify.jsp">
  ...
  <table width="75%" align="center" border>
	...
	<tr><th>전화번호</th>
         <td><input type="text" name="s_phone" size="50" value="<%= s_phone %>"> </td>
     </tr>
	 <tr><th>연체 수</th>
